...
```kotlin
dependencies {
    testImplementation("io.github.stefankoppier:kotlin-builder-dsl:0.0.3")
}
```
...
```kotlin
class DayOfWeekEnumBuilder(faker: Faker = Faker()) : EnumBuilder<DayOfWeek, DayOfWeekEnumBuilder> {
