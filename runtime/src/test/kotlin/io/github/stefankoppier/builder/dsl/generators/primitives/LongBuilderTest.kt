...
import io.github.stefankoppier.builder.dsl.generators.primitives.LongGenerator
...
class LongBuilderTest {
    ...
    fun random() {
        ...
        assertEquals(1, LongGenerator(faker)())
    }

    @Test
    fun constant() {
        assertEquals(2, LongGenerator().constant(2)())
    }
